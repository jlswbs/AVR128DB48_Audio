// Karplus-Strong kick drum and hihat //
...
void triggerKick(float frequency) {
  ...
  for (int i = 0; i < delayLength; i++) {
    ...
    int16_t rawNoise = random(-512, 511);
    burstFilterLast = (int16_t)((rawNoise + (burstFilterLast * 3)) >> 2);
    delayBuffer[i] = burstFilterLast;
